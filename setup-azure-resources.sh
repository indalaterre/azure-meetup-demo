...
echo "=========================================="
create_container_app "$CA_MONOLITH_JVM" "external" 10990 "$ACR_LOGIN_SERVER/modular-monolith/modular-monolith:jvm"
...
echo "=========================================="
create_container_app "$CA_MONOLITH_NATIVE" "external" 10990 "$ACR_LOGIN_SERVER/modular-monolith/modular-monolith:native"
...
echo "  az containerapp update -g $RG_NAME -n $CA_MONOLITH_JVM --image $ACR_LOGIN_SERVER/modular-monolith/modular-monolith:jvm"
echo ""
...
echo "  az containerapp update -g $RG_NAME -n $CA_MONOLITH_NATIVE --image $ACR_LOGIN_SERVER/modular-monolith/modular-monolith:native"
echo ""
